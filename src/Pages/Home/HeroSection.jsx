    ...
    return (
      ...
      <section id="heroSection" className="hero--section">
        ...
        <div className="hero--section--content--box">
          ...
          <div className="footer--items-hero">
          <ul>
            <li>
              <a
                href="https://github.com/yashwanth1011"
            ...
            <li>
              <a
                href="https://leetcode.com/u/yashwanthchennu1999/"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
            ...
            <li>
              <a
                href="https://ychennuportfolio.netlify.app"
                className="navbar--content"
                target="_blank"
                rel="noreferrer"
              >
